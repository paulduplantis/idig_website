          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="bg-white rounded-2xl p-8 shadow-md">
                <h2 className="text-2xl font-medium mb-4">i<em>DIG</em> Principles</h2>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-md">
                <h2 className="text-2xl font-medium mb-4">The i<em>DIG</em> Vision</h2>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md mb-16">
              <h2 className="text-2xl font-medium mb-4">How i<em>DIG</em> Works</h2>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Browse the web naturally while i<em>DIG</em> quietly helps you identify meaningful content.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md mb-16">
              <h2 className="text-2xl font-medium mb-4">The Story Behind i<em>DIG</em></h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                Born from a frustration with the superficial nature of modern web consumption, 
                i<em>DIG</em> emerged as a response to the question: "How can we make the internet a place 
              ...
              <p className="text-gray-600 leading-relaxed">
                i<em>DIG</em> is our attempt to create technology that aligns with human flourishing—tools that 
