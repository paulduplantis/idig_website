...
const blogPosts: Record<string, BlogPostData> = {
  "introduction-to-idig": {
    ...
    content: [
      ...
      "I am also working on incorporating an ad model I call Tunable Ads where the user will be able to filter products and services independently as well as when they are baked into native content. I had written an essay a few years back on this as this is one of my biggest gripes about the evolution of the web in how noisy it has become with ads. I argue it is not advertising if you are interested, so why not build tools to support this? This will be part of the attractor model I will write about more in future posts.",
      "Eventually, I would love to get iDIG to a place where the user interface is highly customizable to allow people to tune the framework and AI summaries to how they see the world. Or to allow communities to customize the framework for their needs. I believe mental health should be the next collective moonshot and see iDIG as a potential tool to privately align social workers more resonantly with people in need to provide access to initial conversations outside institutional barriers.",
